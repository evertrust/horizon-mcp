 ...
 *
 * Minimal valid payloads, mapped onto the MCP tool's snake_case inputs
 * (see src/tools/config/storages.ts).
 *
 ...
 *     checksum_mode, part_buffer_size (the API requires all of these;
