...
_QA_CAMPAIGN = "e2e-discovery-import"
_QA_PROFILE = "e2e-discovery-monitoring"
...
async def test_discovery_import_workflow(e2e_mcp: FastMCP) -> None:
    ...
    Uses the pre-existing QA campaign 'e2e-discovery-import' and monitored profile
    'e2e-discovery-monitoring'. This test verifies the end-to-end flow:
