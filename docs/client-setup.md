...
The full server registers 221 tools. These tools use approximately 45,000 to 55,000 context tokens before the first user message.
...
Start Claude Code from that directory. The server makes the 221 tools available immediately.
