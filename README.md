...
- **215 tools across 12 domains**, each annotated with a safety tier (`read-only`, `mutating-safe`, `mutating-destructive`).
...
The 215 tools are in 12 domains. Each tool has explicit usage guidance for smaller models.
...
| [Tool reference](docs/tools-reference.md)          | All 215 tools by domain with safety tiers                           |
