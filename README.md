...
| `HORIZON_SSE_MAX_DURATION`        | `3600`      | Absolute lifetime in seconds for every HTTP response (`1` to `86400`), including notification streams; SSE keep-alives do not reset it. Must be greater than `HORIZON_EXPORT_TIMEOUT` to leave headroom above the export budget. |
