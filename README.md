...
| `HORIZON_CREDENTIAL_CACHE_TTL`    | `300`       | Seconds before a cached credential is retired and revalidated (`30` to `3600`). Retirement blocks new reuse immediately; cleanup waits for in-flight requests.             |
