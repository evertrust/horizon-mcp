 ...
 *
 * Build-time constant resolved from the bundled OpenAPI certificate-profile request schema.
...
export const certificateProfileRequestSchema = {
  ...
  description:
    'Polymorphic certificate profile request body. Discriminated by the lowercase string field "module". One of 11 documented subtypes (OpenAPI). Server-populated fields _id and tenant are ignored/stripped on read.',
  oneOf: [
    {
