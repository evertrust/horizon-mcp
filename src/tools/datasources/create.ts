...
const CREATE_DNS_DATASOURCE_CONFIG = {
  description:
...
const CREATE_LDAP_DATASOURCE_CONFIG = {
  description:
...
const CREATE_REST_DATASOURCE_CONFIG = {
  description:
